...
import { AppBar, Carousel, Progress } from "@skeletonlabs/skeleton-react";
import AOS from "aos";
import {
	Activity,
	ArrowDown,
			...
			<section className="relative flex flex-col items-center justify-center pt-24 pb-20 text-center md:pt-40 md:pb-32">
				...
				<div className="max-w-4xl" data-aos="fade-up">
					...
					<h1 className="mb-6 font-bold text-5xl leading-tight tracking-tighter md:text-7xl lg:text-[5rem] lg:leading-[1.1]">
						...
						<span className="text-surface-600-400">Share securely.</span>
					</h1>

					<p className="mx-auto mb-10 max-w-2xl font-light text-surface-600-400 text-xl leading-relaxed">
						Self-hostable, open-source, and encrypted by default. Built with
						RustFS for speed and FastAPI for reliability. Take back control of
						your data.
					</p>
			...
			<section className="py-24 md:py-32">
				<div className="mx-auto mb-16 max-w-3xl text-center" data-aos="fade-up">
					...
					<p className="font-light text-lg text-surface-600-400 leading-relaxed">
						Simple, flexible deployment for your home lab or VPS. Spin up our
						Docker containers and take back ownership of your files.
					</p>
				</div>
			...
			>
				<div className="mb-16 grid grid-cols-1 gap-8 md:grid-cols-2 md:items-end">
					<div data-aos="fade-right">
						...
						<p className="font-light text-lg text-surface-600-400 leading-relaxed">
							Detailed guides for self-hosting, contributing, and hacking on the
							API. Everything you need to run Chithi your way.
						</p>
					</div>
				</div>
