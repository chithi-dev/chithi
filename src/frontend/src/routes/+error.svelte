...
<div
	class="relative flex min-h-svh items-center justify-center overflow-hidden bg-background p-4 transition-colors duration-500"
>
	...
	<div in:fly={{ y: 20, duration: 800 }} class="z-10 w-full max-w-md">
		...
		>
			...
			<Card.Footer
				class="flex flex-col gap-3 border-t border-border/50 bg-muted/20 py-6"
			>
