...
export function compress(entries, pwd) {
    var ptr0 = isLikeNone(pwd) ? 0 : passStringToWasm0(pwd, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
 ...
 * @returns {Uint8Array}
 */
export function decrypt_chunks_parallel(flattened_chunks, key, base_iv, start_index, progress_callback) {
    ...
    const ptr2 = passArray8ToWasm0(base_iv, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.decrypt_chunks_parallel(ptr0, len0, ptr1, len1, ptr2, len2, start_index, isLikeNone(progress_callback) ? 0 : addToExternrefTable0(progress_callback));
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v4 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
 ...
 * @returns {Uint8Array}
 */
export function encrypt_chunks_parallel(flattened_chunks, key, base_iv, start_index, progress_callback) {
    const ptr0 = passArray8ToWasm0(flattened_chunks, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
    const ptr2 = passArray8ToWasm0(base_iv, wasm.__wbindgen_malloc);
    const len2 = WASM_VECTOR_LEN;
    const ret = wasm.encrypt_chunks_parallel(ptr0, len0, ptr1, len1, ptr2, len2, start_index, isLikeNone(progress_callback) ? 0 : addToExternrefTable0(progress_callback));
    if (ret[3]) {
        throw takeFromExternrefTable0(ret[2]);
    }
    var v4 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
