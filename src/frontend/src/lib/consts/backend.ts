...
export const Api = {
	...
	get SPEEDTEST() {
		return {
			get DOWNLOAD() {
				return url('speedtest/download');
			},
			get UPLOAD() {
				return url('speedtest/upload');
			},
			get LATENCY() {
				return url('speedtest/latency');
			}
		} as const;
	}
};
