...
class Room(models.Model):
    ...
    expire_after = models.IntegerField(db_comment="Seconds until room expires after creation")
...
class RoomHost(models.Model):
    ...
    host_token = models.CharField(max_length=64, db_comment="SHA-256 hash of host token")
    created_at = models.DateTimeField(auto_now_add=True, editable=False)
