...
pub fn sdk_compress_and_encrypt(
    ...
    use crate::send_crypto::{Keychain, parallel_encrypt_data};
    ...
    let encrypted = parallel_encrypt_data(&compressed, &key, &base_iv)?;
...
pub fn sdk_decrypt_and_decompress(
    ...
    use crate::send_crypto::{derive_key, parallel_decrypt_data};
    ...
    // Decrypt in parallel
    let decrypted = parallel_decrypt_data(encrypted, &key, &base_iv)?;
