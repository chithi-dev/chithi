 ...
 */
export function _init_panic_hook() {
 ...
 * @returns {any[]}
 */
export function decompress_7z(data, password) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any[]}
 */
export function download(bundle, password) {
 ...
 * @returns {Uint8Array}
 */
export function downloadData(bundle_json, password) {
 ...
 * @returns {Uint8Array}
 */
export function upload(names, datas, password) {
    const ptr0 = passArrayJsValueToWasm0(names, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArrayJsValueToWasm0(datas, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {string}
 */
export function uploadData(data, password) {
    let deferred4_0;
    let deferred4_1;
    try {
        const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
 ...
 * @returns {Uint8Array}
 */
export function wasm_argon2_derive(password, salt, iterations, memory_cost_kib, hash_length) {
 ...
 * @returns {Uint8Array[]}
 */
export function wasm_decrypt_all(records, key) {
 ...
 * @returns {Uint8Array}
 */
export function wasm_decrypt_chunk(data, key, nonce) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array[]}
 */
export function wasm_decrypt_chunks_parallel(chunks, key, base_iv) {
 ...
 * @returns {Uint8Array}
 */
export function wasm_decrypt_record(data, key) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function wasm_derive_key(password, salt) {
    const ptr0 = passArray8ToWasm0(password, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(salt, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array[]}
 */
export function wasm_encrypt_all(records, key) {
    const ptr0 = passArrayJsValueToWasm0(records, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function wasm_encrypt_chunk(data, key, nonce) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array[]}
 */
export function wasm_encrypt_chunks_parallel(chunks, key, base_iv) {
    const ptr0 = passArrayJsValueToWasm0(chunks, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function wasm_encrypt_record(data, key) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passArray8ToWasm0(key, wasm.__wbindgen_malloc);
    const len1 = WASM_VECTOR_LEN;
 ...
 * @returns {Uint8Array}
 */
export function wasm_generate_ikm() {
 ...
 * @returns {string}
 */
export function wasm_generate_secret() {
    let deferred1_0;
    let deferred1_1;
    try {
 ...
 * @returns {Uint8Array}
 */
export function wasm_get_chunk_nonce(base_iv, chunk_index) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('wasm_bindings_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
